    ...
    while succ_cnt < max_N:
        ...
        if True:
            ...
            if ifConv:
                ...
                # with open('trajs_normal_3/optimized_trajectories_%s.npy' % succ_cnt, 'wb') as f:
                ...
                data = np.load("trajs_normal_3/optimized_trajectories_%s.npy" % succ_cnt)
                plt.plot(data[:,0], data[:,1], linestyle='dashdot')
                data2 = np.load("trajs_normal_3/actual/optimized_trajectories_%s.npy" % succ_cnt)
